...
from model.vgg_models import VGG_backbone, EBM_Prior, FCDiscriminator
...
for epoch in range(1, opt.epoch+1):
    ...
    for i, pack in enumerate(train_loader, start=1):
        for rate in size_rates:
            ...
            pred = model(images, depths, z_g_noise)
        ...
        if i % 10 == 0 or i == total_step:
            print('{} Epoch [{:03d}/{:03d}], Step [{:04d}/{:04d}], Loss: {:.4f}, Loss_Dis: {:.4f}, Loss_EBM: {:.4f}'.

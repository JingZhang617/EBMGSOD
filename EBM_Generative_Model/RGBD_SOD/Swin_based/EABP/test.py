...
generator.load_state_dict(torch.load(option['ckpt_save_path']+'/100_0.1130_gen.pth'))
generator.eval()
ebm_model.load_state_dict(torch.load(option['ckpt_save_path']+'/100_0.1130_ebm.pth'))
ebm_model.eval()

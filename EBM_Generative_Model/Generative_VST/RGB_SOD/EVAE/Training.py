...
def main(local_rank, num_gpus, args):
    ...
    for epoch in range(args.epochs):
        ...
        for i, data_batch in enumerate(train_loader):
            ...
            z_e_0, z_g_0 = net(images, z_prior0, z_post0, label_224, prior_z_flag=True, istraining=True)
            ...
            for kk in range(args.g_l_steps):
                _, _, _, gen_res, _ = net(images, z_prior0, z, label_224, prior_z_flag=False, istraining=True)
            ...
            _, _, pred_prior, pred_post, latent_loss = net(images, z_e_noise, z_g_noise, label_224,
                                                           prior_z_flag=False,
                                                           istraining=True)

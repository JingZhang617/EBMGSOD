...
def main(local_rank, num_gpus, args):
    ...
    for epoch in range(args.epochs):
        ...
        for i, data_batch in enumerate(train_loader):
            ...
            outputs_saliency, outputs_contour = net(images, z_g_noise)
            ...
            images_1_16 = F.upsample(images, size=(mask_1_16.shape[2], mask_1_16.shape[3]), mode='bilinear', align_corners=True)

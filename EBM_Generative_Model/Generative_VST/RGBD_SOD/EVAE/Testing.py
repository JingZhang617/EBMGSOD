    ...
    for test_dir_img in test_paths:
        ...
        for i, data_batch in enumerate(test_loader):
            ...
            for iter in range(args.iter_num):
                ...
                z_e_0 = net(images, depths, z_prior0, z_post0, prior_z_flag=True, istraining=False)
                ...
                outputs_saliency, outputs_contour = net(images, depths, z_e_noise, z_post0, images, prior_z_flag=False, istraining = False)

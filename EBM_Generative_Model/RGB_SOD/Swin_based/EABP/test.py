...
generator.load_state_dict(torch.load(option['ckpt_save_path']+'/50_0.1060_gen.pth'))
generator.eval()
ebm_model.load_state_dict(torch.load(option['ckpt_save_path']+'/50_0.1060_ebm.pth'))
ebm_model.eval()

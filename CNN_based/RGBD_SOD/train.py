...
parser.add_argument('--lr_gen', type=float, default=6e-5, help='learning rate for generator')
    ...
    for i, pack in enumerate(train_loader, start=1):
        for rate in size_rates:
            ...
            for kk in range(opt.g_l_steps):
                gen_res,_ = generator(images, depths, z)
            ...
            pred_init, pred_ref = generator(images,depths,z_g_noise)
